    ...
    <div class="max-w-3xl w-full px-4 sm:px-8">
      ...
      <div class="flex items-center">
        <div class="flex-1 pr-3 sm:pr-6">
          <input id="subscribe-email" type="email" placeholder="请输入小说名称..." class="appearance-none block w-full py-3 px-4 leading-none sm:leading-normal border border-gray-100 placeholder-gray-500 rounded-lg focus:outline-none focus:shadow-outline-blue focus:z-10 sm:px-5 text-sm sm:text-lg">
        </div>
